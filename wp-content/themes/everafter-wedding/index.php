...
?>
  <main id="content">
        ...
        <div class="col-lg-8 col-md-8 col-12">
          ...
          <?php endwhile; ?>
            <?php the_posts_pagination( array(
              'prev_text' => __( 'Previous page', 'everafter-wedding' ),
              'next_text' => __( 'Next page', 'everafter-wedding' ),
              'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'everafter-wedding' ) . ' </span>',
            ) ); ?>
          <?php else : ?>
    ...
    <?php if (has_tag()) { ?>
      <div class="post-tags">
          <span><?php esc_html_e('Tags:', 'everafter-wedding'); ?></span>
          <?php the_tags('', ' '); ?>
      </div>
    <?php } ?>
  <?php
