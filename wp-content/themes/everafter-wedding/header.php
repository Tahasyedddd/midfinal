...
<body <?php body_class(); ?>>
  ...
  <a class="skip-link screen-reader-text" href="#content"><?php echo esc_html__('Skip to content', 'everafter-wedding'); ?></a>
    ...
    <div class="col-lg-9 col-12">
      <div>
          <header id="Main-head-class" class="site-header">
            <!-- before header hook -->
            <?php do_action('everafter_wedding-_before_header'); ?>
